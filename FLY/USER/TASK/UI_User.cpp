...
Window window7(7);
Button Button7_1;
int Button0_1_Event(Event event){if (event == press){window1.Refresh();}return 0;}
int Button0_2_Event(Event event){if (event == press){window2.Refresh();}return 0;}
int Button0_3_Event(Event event){if (event == press){window6.Refresh();}return 0;}
int Button0_4_Event(Event event){if (event == press){window4.Refresh();}return 0;}
int Button0_5_Event(Event event){if (event == press){window3.Refresh();}return 0;}
int Button0_6_Event(Event event){if (event == press){window5.Refresh();}return 0;}
int Button1_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button1_2_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button1_3_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button2_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button2_2_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button2_3_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button2_4_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button2_5_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button3_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button4_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button5_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button6_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
int Button7_1_Event(Event event){if (event == press){window0.Refresh();}return 0;}
void UI_Init(void){
