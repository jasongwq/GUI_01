...
/**
  ...
  * @param TIMx: where x can be  1, 2, 3, 4, 5 or 8 to select the TIM 
  *   peripheral.
  * @param TIM_TIxExternalCLKSource: Trigger source.//触发
  *   This parameter参数 can be one of the following values:
  * @arg TIM_TIxExternalCLK1Source_TI1ED: TI1 Edge Detector
  * @arg TIM_TIxExternalCLK1Source_TI1: Filtered 滤波 Timer Input 1
  * @arg TIM_TIxExternalCLK1Source_TI2: Filtered Timer Input 2
  * @param TIM_ICPolarity: specifies the TIx Polarity.极性
